...
from gatorgrade.output.output import create_markdown_report
...
def gatorgrade(
    ...
    if ctx.invoked_subcommand is None:
        # if they want to review their last gg run:
        if review is True:
            # use appdata to grab the json data from last run
            json_report = {}
            # convert the json into md and print it out to the terminal
            print(create_markdown_report(json_report))
        # else, they want to run gg again:
        else:
