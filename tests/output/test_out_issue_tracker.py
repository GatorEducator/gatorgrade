...
from gatorgrade.output.out_issue_tracker import issueExecute
from gatorgrade.output.out_issue_tracker import issueMode
from gatorgrade.output.out_issue_tracker import issueReport
...
def test_create_issue_successfully():
    ...
    status = issueExecute.create_issue(
        github_object=github_mock_api.MockGH(),
        repo_name="test_repo",
        issue_name="Insight",
...
def test_rewrite_issue_fails():
    ...
    status = issueExecute.rewrite_issue(
        github_object=github_mock_api.MockGH(),
        repo_name="test_repo",
        issue_name="Insight",
        new_issue_body="hello world",
    )
...
def test_rewrite_issue_pass():
    ...
    issueExecute.create_issue(
        github_object=github_mock_object,
        repo_name="test_repo",
        issue_name="Insight",
        issue_body="hello world",
    )
    status = issueExecute.rewrite_issue(
        ...
        repo_name="test_repo",
        issue_name="Insight",
        new_issue_body="rewrite hello world",
    )
...
def test_update_issue_fails():
    ...
    # Rewrite issue directly without create an issue before
    status = issueExecute.update_issue(
        github_object=github_mock_api.MockGH(),
        repo_name="test_repo",
        issue_name="Insight",
        added_issue_body="hello world",
    )
    assert status is False
...
def test_update_issue_pass():
    ...
    status = issueExecute.update_issue(
        ...
        repo_name="test_repo",
        issue_name="Insight",
        added_issue_body="hello world again",
    )
...
def test_multi_issue_mode_pass():
    ...
    github_mock_object = github_mock_api.MockGH()
    issue_mode_instance = issueMode(
        api_object=github_mock_object, repo_name="test_repo"
    )
...
def test_rewrite_issue_mode_creates_new_issue():
    ...
    create_issue_flag = issue_mode_instance.rewrite_issue_mode(
        issue_name="Insight", issue_body="hello world"
    )
...
def test_comment_issue_mode_creates_new_issue():
    ...
    create_issue_flag = issue_mode_instance.comment_issue_mode(
        issue_name="Insight", issue_body="hello world"
    )
    assert create_issue_flag == True
