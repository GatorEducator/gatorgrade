...
GatorGrade's auto-hinting feature, you need to run it with `uvx --from 'gatorgrade[auto-hint]' gatorgrade`
as this will load in the optional dependencies that support hint generation.
